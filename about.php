...
<head>
    ...
    <title>About Us - eTax consultants Pakistan</title>
    <meta name="description" content="Learn about eTax consultants Pakistan, our 20+ years of experience in tax consultancy, and our commitment to providing expert tax solutions across Pakistan.">
...
<body class="font-sans antialiased">
    ...
    <section class="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-4xl md:text-5xl font-bold mb-6">
                About <span class="text-yellow-300">eTax consultants</span>
            </h1>
            <p class="text-xl text-blue-100 max-w-3xl mx-auto">
                Pakistan's leading tax consultancy firm with over two decades of experience 
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div>
                    ...
                    <p class="text-lg text-gray-600 mb-6 leading-relaxed">
                        Founded in 2003, eTax consultants has been at the forefront of tax consultancy in Pakistan, 
                        helping thousands of clients navigate the complex landscape of Pakistani taxation.
                    </p>
                    
                    <p class="text-lg text-gray-600 mb-6 leading-relaxed">
                        What started as a small practice has grown into one of Pakistan's most trusted 
                        tax consultancy firms, serving clients across all major cities including Karachi, 
                ...
                <div class="relative">
                    <div class="bg-gradient-to-br from-blue-50 to-yellow-50 rounded-2xl p-8">
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                    Why Choose <span class="text-blue-600">eTax consultants</span>
                </h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white rounded-xl p-6 text-center shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-3">Nationwide Presence</h3>
                    <p class="text-gray-600">Offices across Pakistan ensuring local expertise and accessibility.</p>
                </div>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                    Our <span class="text-blue-600">Leadership</span>
                </h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                    ...
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-2">Amjad Javaid Hashmi</h3>
                        <p class="text-blue-600 font-medium mb-3">Founder & Chief Advisor</p>
                        <p class="text-gray-600 text-sm leading-relaxed">
                            With over 20 years of experience in tax law, Mr. Hashmi is a leading expert 
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                    <div class="h-48 bg-gradient-to-br from-green-100 to-green-200 flex items-center justify-center">
                        <i class="fas fa-user-graduate text-green-600 text-6xl"></i>
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-2">Senior Associates</h3>
                        <p class="text-green-600 font-medium mb-3">Expert Tax Professionals</p>
                        <p class="text-gray-600 text-sm leading-relaxed">
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 text-sm leading-relaxed">
                            ...
                            client service, maintaining the high standards eTax consultants is known for.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                    Our <span class="text-blue-600">Offices</span>
                </h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-white rounded-xl p-6 text-center shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-3">Karachi</h3>
                    <p class="text-gray-600 text-sm mb-3">Suite No.14, 6th Floor, Rimpa Plaza, M.A Jinnah Road</p>
                    <p class="text-blue-600 font-medium">+92 21 3582 1757</p>
                </div>
                ...
                <div class="bg-white rounded-xl p-6 text-center shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-3">Lahore</h3>
                    <p class="text-gray-600 text-sm mb-3">2nd Floor, Badar Centre, 5 Mclagon Road</p>
                    <p class="text-green-600 font-medium">+92-42-7122735</p>
                </div>
                ...
                <div class="bg-white rounded-xl p-6 text-center shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-3">Islamabad</h3>
                    <p class="text-gray-600 text-sm mb-3">No. 1, Street 2, Sector G-11/1</p>
                    <p class="text-yellow-600 font-medium">+92 334 514 3163</p>
                </div>
    ...
    <section class="py-16 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="contact.php" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-4 px-8 rounded-lg text-lg transition-all duration-200 transform hover:scale-105 hover:shadow-lg">
